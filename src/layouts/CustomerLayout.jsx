...
function CustomerSidebar({ mobileOpen, setMobileOpen, onLogoutClick }) {
  ...
  const menuItems = [
    ...
    { text: 'My Bookings', path: '/bookings', icon: <ListAltIcon /> },
    { text: 'My Reviews', path: '/reviews', icon: <RateReviewIcon /> },
